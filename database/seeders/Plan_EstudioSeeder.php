...
class Plan_EstudioSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (!$registros) {
            ...
            $plan_estudio->titulo = '000- Sec. Estatal - Bachiller Ciclo Básico (Aulas de Aceleración)';
            ...
            $plan_estudio->titulo = '001- Sec. Estatal - Bachiller en Ciencias Sociales';
            $plan_estudio->duracion_anios = 3;
            $plan_estudio->resolucion = 'Resolución N° 302/12';
            ...
            $plan_estudio->titulo = '002- Sec. Estatal - Bachiller en Ciencias Naturales';
            $plan_estudio->duracion_anios = 3;
            $plan_estudio->resolucion = 'Resolución N° 302/12';
            ...
            $plan_estudio->titulo = '003- Sec. Estatal - Bachiller en Economía y Administración';
            $plan_estudio->duracion_anios = 3;
            $plan_estudio->resolucion = 'Resolución N° 302/12';
            ...
            $plan_estudio->titulo = '172- Sec. Estatal - Bachiller en Turismo';
            $plan_estudio->duracion_anios = 3;
